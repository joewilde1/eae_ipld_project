...
def home_page():
    ...
    with st.sidebar:
        ...
        st.write("**Author:** Joe Wilde")
        st.write("**Instructor:** [Enric Domingo](https://github.com/enricd)")


    # ----- Top title -----
    st.html("""<div style="text-align: center;"><h1 style="text-align: center;">👋 Hi! My name is Joe</h1></div>""")
    ...
    - 🛩️ prev: Bachelors in Economics

    - ❤️ Football (Arsenal)

    - 🤖 secret 

    - 🏂 Football and Beach Volley

    - 📫 How to reach me: joe@gmail.com
